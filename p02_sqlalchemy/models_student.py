...
class Grades(Base):
    ...
    def __repr__(self):
        return f"Student(student={self.student}, grade={self.grade}, data_create={self.data_create}, id={self.id})"

    def __str__(self):
        return f"Student ID: {self.student}, Grade: {self.grade}, Date: {self.data_create}"
